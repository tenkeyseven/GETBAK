...
ex_ref = lpips.im2tensor(lpips.load_image('./lpips_test/ex_ref.png'))
ex_p0 = lpips.im2tensor(lpips.load_image('./lpips_test/ex_p0.png'))
ex_p1 = lpips.im2tensor(lpips.load_image('./lpips_test/ex_p1.png'))
if(use_gpu):
	ex_ref = ex_ref.cuda()
	ex_p0 = ex_p0.cuda()
	ex_p1 = ex_p1.cuda()
