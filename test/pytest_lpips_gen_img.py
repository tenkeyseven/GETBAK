...
parser.add_argument('--ref_path', type=str, default='./lpips_test/ex_ref.png')
parser.add_argument('--pred_path', type=str, default='./lpips_test/ex_p1.png')
...
for i in range(1000):
    ...
    if i % 10 == 0:
        ...
        plt.pause(5e-2)
        plt.imsave('lpips_test/imgs_saved/%04d.jpg'%i,pred_img)
